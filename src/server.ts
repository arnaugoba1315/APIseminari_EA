...
import subjectRoutes from './modules/subjects/subject_routes.js'; // Añadimos la nueva ruta
...
const swaggerOptions = {
    ...
    apis: ['./modules/users/*.js', './modules/forum/*.js', './modules/subjects/*.js'] // Añadido el módulo de subjects
};
...
app.use('/api', subjectRoutes); // Añadimos la nueva ruta de subjects
